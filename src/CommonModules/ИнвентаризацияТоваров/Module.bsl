    ...
    Попытка
        ...
        Если ШтрихкодЕстьВПересчете(ПересчетТоваров,
            ...
            УстановитьКоличествоТовара(ПересчетТоваров,
									   ...
									   ДополнительныеПараметры.НаименованиеХарактеристики);
        Иначе
...
Функция УстановитьКоличествоТовара(Знач Документ,
                                   ...
                                   Знач УникальныйИдентификаторХарактеристики,
                                   Знач Количество,
								   Знач НаименованиеХарактеристики)
...
Функция ПреобразоватьВЧисло(Знач Характеристика) Экспорт
	
	Цена = СтрЗаменить(Характеристика, "*", "");
	Возврат Число(Цена);
