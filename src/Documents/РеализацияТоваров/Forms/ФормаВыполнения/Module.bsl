...
Асинх Процедура СписокТоваровВыборАсинх(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	НаименованиеТовара = НаименованиеТовараВРеализации(ФормаДокумент, ВыбраннаяСтрока);
...
//  Штрихкод - Строка 
&НаСервереБезКонтекста
Функция НаименованиеТовараВРеализации(Знач РеализацияТоваров, Знач Штрихкод)
	
	Возврат РегистрыСведений.ШтрихкодыТоваров.НаименованиеПоШтрихкоду(РеализацияТоваров, Штрихкод);
