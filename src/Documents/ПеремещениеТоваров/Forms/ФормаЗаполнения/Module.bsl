...
Асинх Процедура СписокТоваровВыборАсинх(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	НаименованиеТовара = НаименованиеТовараВПеремещнии(ФормаДокумент, ВыбраннаяСтрока);
...
//  Штрихкод - Строка 
&НаСервереБезКонтекста
Функция НаименованиеТовараВПеремещнии(Знач ПеремещениеТоваров, Знач Штрихкод)
	
	Возврат РегистрыСведений.ШтрихкодыТоваров.НаименованиеПоШтрихкоду(ПеремещениеТоваров, Штрихкод);
