...
Асинх Процедура СписокТоваровВыборАсинх(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	НаименованиеТовара = НаименованиеТовараВПоступлении(ФормаДокумент, ВыбраннаяСтрока);
	...
	ПараметрыФормы.Вставить("Наименование", НаименованиеТовара);
...
// См. РегистрыСведений.ШтрихкодыТоваров.НаименованиеПоШтрихкоду
//
// Параметры:
//  ПоступлениеТоваров - ДокументСсылка.ПоступлениеТоваров
//  Штрихкод - Строка 
&НаСервереБезКонтекста
Функция НаименованиеТовараВПоступлении(Знач ПоступлениеТоваров, Знач Штрихкод)
	
	Возврат РегистрыСведений.ШтрихкодыТоваров.НаименованиеПоШтрихкоду(ПоступлениеТоваров, Штрихкод);
