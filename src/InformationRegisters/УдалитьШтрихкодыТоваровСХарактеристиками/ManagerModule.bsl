...
Процедура ДобавитьШтрихкод(Знач Документ,
	...
	Цена = ИнвентаризацияТоваров.ПреобразоватьВЧисло(ДополнительныеПараметры.НаименованиеХарактеристики);
	МенеджерЗаписи.Сумма = МенеджерЗаписи.Количество * Цена;
...
Процедура УстановитьКоличество(Знач Документ,
                               ...
                               Знач УникальныйИдентификаторХарактеристики,
                               Знач Количество,
							   Знач НаименованиеХарактеристики) Экспорт
	...
	Цена = ИнвентаризацияТоваров.ПреобразоватьВЧисло(НаименованиеХарактеристики);
	МенеджерЗаписи.Сумма = МенеджерЗаписи.Количество * Цена;
...
Функция СуммаДокумента(Знач Документ)Экспорт
	
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      |    УдалитьШтрихкодыТоваровСХарактеристиками.Сумма КАК Сумма
	                      |ИЗ
	                      |	   РегистрСведений.УдалитьШтрихкодыТоваровСХарактеристиками КАК УдалитьШтрихкодыТоваровСХарактеристиками
	                      |ГДЕ
	                      |	   УдалитьШтрихкодыТоваровСХарактеристиками.Документ = &Документ");
